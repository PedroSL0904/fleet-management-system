...
CATALOGO_AUTOS: dict[str, list[tuple[str, str]]] = {
    ...
    "CUPRA": [
        ("FORMENTOR", "Formentor"),
        ("LEON_CUPRA", "Cupra León"),
        ("ATECA_CUPRA", "Cupra Ateca"),
    ],
    "BMW": [
        ("SERIE_1", "Serie 1"),
        ("SERIE_2", "Serie 2"),
...
TODOS_LOS_MODELOS = [
    (codigo, nombre)
    for marca_modelos in CATALOGO_AUTOS.values()
    for codigo, nombre in marca_modelos
]
    ...
    class Meta:
        ...
        widgets: dict[str, forms.Widget] = {
            ...
            "placas": forms.TextInput(
                attrs={
                    "class": "form-control border-primary shadow-sm text-uppercase",
            ...
            "foto": forms.FileInput(
                attrs={"class": "form-control border-primary shadow-sm"}
            ),
        }
...
class AsignacionForm(forms.ModelForm):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        chofer_field.queryset = Chofer.objects.filter(estado="ACTIVO").exclude(
            asignacion__estado="ACTIVA"
        )
...
class MantenimientoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets: dict[str, forms.Widget] = {
            ...
            "descripcion_trabajo": forms.Textarea(
                attrs={"class": "form-control border-primary shadow-sm", "rows": 3}
            ),
            "estado": forms.Select(
                attrs={"class": "form-select border-primary shadow-sm"}
            ),
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        if self.instance and self.instance.pk:
            if self.instance.fecha_servicio:
                self.fields[
                    "fecha_servicio"
                ].initial = self.instance.fecha_servicio.strftime("%Y-%m-%d")
    ...
    class Meta:
        ...
        widgets: dict[str, forms.Widget] = {
            ...
            "fecha_vencimiento": forms.DateInput(
                attrs={"type": "date", "class": "form-control border-primary shadow-sm"}
            ),
        }
