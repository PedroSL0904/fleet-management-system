...
class FinalizarMantenimientoTest(TestCase):
    def setUp(self) -> None:
        ...
        self.mantenimiento = Mantenimiento.objects.create(
            ...
            tipo="CORRECTIVO",
            fecha_servicio=datetime.date.today(),
            costo=Decimal("3000.00"),
            taller="Taller Y",
            descripcion_trabajo="Cambio de frenos",
            estado="EN_PROCESO",
        )
