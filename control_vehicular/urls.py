...
urlpatterns = [
    ...
    # Vehicle Management
    path('agregar-vehiculo/', views.AgregarVehiculoView.as_view(), name='agregar_vehiculo'),
    path('editar-vehiculo/<int:id>/', views.EditarVehiculoView.as_view(), name='editar_vehiculo'),
    ...
    path('registrar-chofer/', views.RegistrarChoferView.as_view(), name='registrar_chofer'),
    path('editar-chofer/<int:id>/', views.EditarChoferView.as_view(), name='editar_chofer'),
    ...
    path('asignar-vehiculo/', views.AsignarVehiculoView.as_view(), name='asignar_vehiculo'),
    path('liberar-vehiculo/<int:id>/', views.liberar_vehiculo, name='liberar_vehiculo'),

    # Maintenance & Insurance
    path('registrar-mantenimiento/', views.RegistrarMantenimientoView.as_view(), name='registrar_mantenimiento'),
    path('editar-mantenimiento/<int:id>/', views.EditarMantenimientoView.as_view(), name='editar_mantenimiento'),
    ...
    path('registrar-poliza/', views.RegistrarPolizaView.as_view(), name='registrar_poliza'),
